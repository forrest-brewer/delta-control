...
// 
// Module: node_2
// Source Path: sd_filter_tb/SD 2nd Order Modulator/SD Filter/node_2
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module node_2
  ...
  wire signed [66:0] Sum1_op_stage1;  // sfix67_En50
  ...
  SD_Mux5 u_SD_Mux5 (.in1(input_rsvd),
  ...
  assign Sum1_stage2_add_cast = Gain_out1[62:42];
  assign Sum1_stage2_add_temp = SD_Mux5_out1 + Sum1_stage2_add_cast;
  assign Sum1_op_stage1 = {{4{Sum1_stage2_add_temp[20]}}, {Sum1_stage2_add_temp, 42'b000000000000000000000000000000000000000000}};
  ...
  SD_Mux1 u_SD_Mux1 (.in1(feedback),
                     .out1(SD_Mux1_out1)  // sfix21_En8
                     );

  assign Sum1_stage3_sub_cast = Sum1_op_stage1[62:42];
